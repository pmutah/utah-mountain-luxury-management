/** Retry + model fallback for Gemini generateContent (JSON mode). */
...
/** Prefer lighter models first when 2.5-flash is saturated. */
...
/**
 * Call Gemini with retries per model and fallback across models.
 */
